...
<div id="wrapper">
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter Your Full Name</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="txtarea1" class="col-sm-2 control-label">Detail Address</label>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="inputPassword" placeholder="Enter Your Email Id">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword" class="col-sm-2 control-label"> Key Skills</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="inputPassword" placeholder="Enter Your skills seprated by (,)">
									</div>
								</div>
								<div class="form-group">
  ...
  <div class="copy_layout">
      <p>Copyright © 2024 WIT BE ELN All Rights Reserved | </p>
  </div>
  </div>
      </div>
      <!-- /#page-wrapper -->
